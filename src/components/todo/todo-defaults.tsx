...
export const intialData: Task[] = [
  ...
  {
    id: "8",
    name: "Migrate Backend to Elysia",
    startDate: "05/06/2024",
    endDate: "18/06/2024",
    users: 2,
    priority: "Important",
  ...
  {
    id: "11",
    name: "Fix Image Compression Bug",
    startDate: "04/06/2024",
    endDate: "05/06/2024",
    users: 2,
    priority: "Urgent",
  ...
  {
    id: "12",
    name: "Create Property Upload Hook",
    startDate: "06/06/2024",
    endDate: "16/06/2024",
    users: 1,
    priority: "Medium",
  ...
  {
    id: "13",
    name: "Implement Wishlist Mutations",
    startDate: "03/06/2024",
    endDate: "13/06/2024",
    users: 1,
    priority: "Important",
  ...
  {
    id: "14",
    name: "Optimize FlashList Sections",
    startDate: "04/06/2024",
    endDate: "09/06/2024",
    users: 2,
    priority: "Medium",
  ...
  {
    id: "15",
    name: "Improve BLE Background Sync",
    startDate: "01/06/2024",
    endDate: "21/06/2024",
    users: 3,
    priority: "Important",
  ...
  {
    id: "19",
    name: "Fix Expo Route Reset Issue",
    startDate: "05/06/2024",
    endDate: "15/06/2024",
    users: 2,
    priority: "Urgent",
  ...
  {
    id: "22",
    name: "Fix Prisma Schema Relations",
    startDate: "02/06/2024",
    endDate: "08/06/2024",
    users: 1,
    priority: "Urgent",
  ...
  {
    id: "23",
    name: "Refactor Property List Hook",
    startDate: "03/06/2024",
    endDate: "13/06/2024",
    users: 2,
    priority: "Medium",
  ...
  {
    id: "24",
    name: "Optimize Image Upload Speed",
    startDate: "06/06/2024",
    endDate: "18/06/2024",
    users: 2,
    priority: "Important",
  ...
  {
    id: "25",
    name: "Create Shipment Tracker UI",
    startDate: "09/06/2024",
    endDate: "20/06/2024",
    users: 3,
    priority: "Medium",
